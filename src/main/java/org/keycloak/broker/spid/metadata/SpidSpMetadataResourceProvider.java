...
import org.keycloak.broker.spid.metadata.contacttype.ContactTypeMgr;
...
public class SpidSpMetadataResourceProvider implements RealmResourceProvider {
    ...
    public Response get() {
        try
        {
            ...
            final Optional<OtherContactInfo> otherContactInfo = MappingFunctions.toOtherContact(firstSpidProvider.getConfig());
            final Optional<BillingContactInfo> billingContactInfo = MappingFunctions.toBillingContact(firstSpidProvider.getConfig());
        ...
        throws ConfigurationException
    {
            ...
            organizationUrls != null && organizationUrls.length > 0)
        {
            ...
            // Add one or more ContactType
            ContactTypeMgr.customizeEntityDescriptor(entityDescriptor, otherContact, billingContact);
