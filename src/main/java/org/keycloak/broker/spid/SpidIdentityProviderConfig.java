...
public class SpidIdentityProviderConfig extends IdentityProviderModel {
    ...
    public String getBillingContactSitePostalCode() {
        return getConfig().get(BILLING_CONTACT_SITE_POSTAL_CODE);
    }
    
    public void setBillingContactSitePostalCode(String billingContactSitePostalCode) {
        getConfig().put(BILLING_CONTACT_SITE_POSTAL_CODE, billingContactSitePostalCode);
    }
